        ...
        <div class="col-md-12 nopadding">
          <div class="mn-string">
            <div class="mn-hundred">
              <div id="myStat" data-dimension="200" data-text="100%" data-info="Total Bookings" data-width="4" data-fontsize="38" data-percent="100" data-fgcolor="#61a9dc" data-bgcolor="#f5f5f5" data-fill="#fff"></div>
              <div id="myStat1" data-dimension="200" data-text="75%" data-info="Confirm Booking" data-width="4" data-fontsize="38" data-percent="75" data-fgcolor="#34a017" data-bgcolor="#f5f5f5" data-fill="#fff"></div>
              <div id="myStat2"  data-dimension="200" data-text="15%" data-info="Cancel Booking" data-width="4" data-fontsize="38" data-percent="15" data-fgcolor="#d51717" data-bgcolor="#f5f5f5" data-fill="#fff"></div>
              <div id="myStat3"  data-dimension="200" data-text="10%" data-info="Pending Booking" data-width="4" data-fontsize="38" data-percent="10" data-fgcolor="#ff5c30" data-bgcolor="#f5f5f5" data-fill="#fff"></div>
            </div>
          </div>
        </div>
        <div class="col-md-12 nopadding">
                    <div class="mn-edit">
                      <div class="col-lg-12">
                            <section id="section-3">
                              <ul class="tabs1">
                                <li><a href='#tab1'><i class="fa fa-plane"></i><?php echo $this->lang->line("user_report_flight"); ?> </a></li>
                                <li><a href='#tab2'><i class="fa fa-hotel"></i> <?php echo $this->lang->line("user_report_hotels"); ?></a></li>                                
                                <li><a href='#tab3'><i class="fa fa-map-marker"></i><?php echo $this->lang->line("user_report_tours"); ?> </a></li>
                              </ul>
                              <div id='tab1'>
