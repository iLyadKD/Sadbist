        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="col-md-12" style="margin-bottom:10px">
                  ...
                  <img src="<?php echo base_url();?>admin/upload_files/common/images/default.png" alt="User Avatar"  width="120" class="img-circle" style="border:1px solid #CCC;padding:10px;" />
                  <p class="text-center"><?php if($rows->user_type_from==4){ echo "You";} else {  echo $rows->replied_by; }?></p>
                  </div>
                  <div class="col-md-10" style="border:1px solid #CCC;min-height:100px;background:#FFF;padding:10px;">
                  <?php  echo $rows->message;?>
                  <?php if($rows->attachment){ ?>
                  <p><a href="<?php  echo base_url('admin/upload_files/'.$rows->attachment);?>"> Attachment</a></p>
                  <?php } ?>
                  <br>
