...
<?php } ?>
								...
								<div class="col-md-12">
									<table class="table table-bordered">
										...
										<tr ng-repeat="fare_breakdown in flight_row.prices">
											...
											<td>
												<span ng-bind="fare_breakdown.base_cost"></span>
												<?php
											...
											<td>
												<span ng-bind="fare_breakdown.total_tax"></span>
												<?php
												if($_SESSION['default_language']=='en')
		                                     		{ echo $this->data["default_currency"]; } 
												else{ if($_SESSION['default_currency']=="IRR"){ echo IRR_fCURRENCY;} else{ echo USDFAR_CURRENCY; } } 
											...
											<td>
												<span ng-bind="fare_breakdown.total_cost"></span>
												<?php
												if($_SESSION['default_language']=='en')
		                                     		{ echo $this->data["default_currency"]; } 
												else{ if($_SESSION['default_currency']=="IRR"){ echo IRR_fCURRENCY;} else{ echo USDFAR_CURRENCY; } } 
											...
											<td>
												<span ng-bind="(fare_breakdown.total_cost * fare_breakdown.quantity)"></span>
                                               <?php
												if($_SESSION['default_language']=='en')
		                                     		{ echo $this->data["default_currency"]; } 
												else{ if($_SESSION['default_currency']=="IRR"){ echo IRR_fCURRENCY;} else{ echo USDFAR_CURRENCY; } } 
										...
										<tr>
											...
											<td>
												<span ng-bind="flight_row.admin_cost"></span>
												<?php
												if($_SESSION['default_language']=='en')
		                                     		{ echo $this->data["default_currency"]; } 
												else{ if($_SESSION['default_currency']=="IRR"){ echo IRR_fCURRENCY;} else{ echo USDFAR_CURRENCY; } } 
										...
										<tr>
											...
											<td>
												<span ng-bind="flight_row.discount"></span>
												<?php
												if($_SESSION['default_language']=='en')
		                                     		{ echo $this->data["default_currency"]; } 
												else{ if($_SESSION['default_currency']=="IRR"){ echo IRR_fCURRENCY;} else{ echo USDFAR_CURRENCY; } } 
										...
										<tr>
											<td colspan="3"></td>
											<td><?php echo $this->lang->line("fare_price"); ?></td>
											<td>
												<span ng-bind="flight_row.total_cost"></span>
												<?php
												if($_SESSION['default_language']=='en')
		                                     		{ echo $this->data["default_currency"]; } 
												else{ if($_SESSION['default_currency']=="IRR"){ echo IRR_fCURRENCY;} else{ echo USDFAR_CURRENCY; } } 
													...
													<h3><?php echo $this->lang->line("traveller_details"); ?></h3>
															...
															<li>
																...
																<div class="timeline-panel">
																	...
																	<?php
																		...
																		for ($i = 0; $i < $adult; $i++)
																		{
																			...
																			if($i === 0)
																			{ 
																				$data_sel_comp['id'] = $user_details->general;
																				$salutation = $data_sel_comp['salutation'] = $user_details->general = '0';
																				$fname = $data_sel_comp['fname'] = $user_details->firstname;
																				$lname = $data_sel_comp['lname'] = $user_details->lastname;
																				$name_fa = $data_sel_comp['name_fa'] = $user_details->name_fa;
																				$nationality = $data_sel_comp['nationality'] = $user_details->country;
																				$dob = date("d-m-Y", strtotime($user_details->dob));
																				$passport_no = $data_sel_comp['passport_no'] = $user_details->passport_no;
																				$passport_no_expire = date("d-m-Y", strtotime($user_details->passport_exp_date));
																				$national_id = $data_sel_comp['national_id'] = $user_details->national_id;

																				$data_sel_comp['dob'] = date("Y-m-d", strtotime($user_details->dob));
																				$data_sel_comp['passport_exp'] = date("Y-m-d", strtotime($user_details->passport_exp_date));

																				$data_sel_comp_json = json_encode($data_sel_comp); 
																			}
																	?>
																...
																<div class="traveller_div" id="adult_traveller<?php echo $i; ?>">
																	...
																	<div class="col-md-12 mn_nopadding">
																		...
																		<div class="col-md-5 nopadding mob_overflo">
                                                                   ...
                                                                   <div class="col-md-2 col-sm-2 nopadding salutation">
																		...
																		<div class="col-md-3 col-sm-5 mnopad fname">
																			<div class="form-group inputtext">
																				<input type="text" autocomplete="off" autofocus data-rule-pattern="^([a-zA-Z]([a-zA-Z]+ ?)*)$" data-msg-pattern="<?php echo $this->lang->line('only_alphabetics_error'); ?>" data-rule-required="true" data-msg-required="<?php echo $this->lang->line("required_star"); ?>" name="adult_fname[]" class="inputs_group" placeholder="<?php echo $this->lang->line('first_name'); ?>" title="<?php echo $this->lang->line('first_name'); ?>" id="adult_fname<?php echo $i; ?>" value="<?php echo $fname; ?>">
																			</div>
																		</div>
                                                                        ...
                                                                        <div class="col-md-7 nopadding mob_overflo"> 
																		<div class="col-md-3 col-sm-3 mnopad mob_overflo  nationality">
																		...
																		<div class="col-md-2 col-sm-2 mnopad passport_exp">
																			<div class="form-group inputtext">
																				<input type="text" autocomplete="off" disabled data-rule-required="true" data-msg-required="<?php echo $this->lang->line("required_star"); ?>" name="adult_passport_expire[<?php echo $i; ?>]" placeholder="<?php echo $this->lang->line("passport_expiry_date"); ?>" title="<?php echo $this->lang->line("passport_expiry_date"); ?>" class="inputs_group from_current_date"  id="adult_passport_expire<?php echo $i; ?>" value="<?php echo $passport_no_expire; ?>">
																			</div>
																		</div>
																...
																<div class="traveller_div" id="child_traveller<?php echo $i; ?>">
																	<div class="col-md-12 mn_nopadding">
																		...
																		<div class="col-md-3 col-sm-2 mnopad fname">
																			<div class="form-group inputtext">
																				<input type="text" autocomplete="off" autofocus data-rule-pattern="^([a-zA-Z]([a-zA-Z]+ ?)*)$" data-msg-pattern="<?php echo $this->lang->line('only_alphabetics_error'); ?>" data-rule-required="true" data-msg-required="<?php echo $this->lang->line("required_star");
																		...
																		<div class="col-md-2 col-sm-2 mnopad d_o_b">
																			<div class="form-group inputtext">
																				<input type="text" autocomplete="off" data-rule-required="true" data-msg-required="<?php echo $this->lang->line("required_star");
																					?>" name="child_dob[]" class="inputs_group till_current_date child" readonly placeholder="<?php echo $this->lang->line('date_of_birth'); ?>" title="<?php echo $this->lang->line('date_of_birth'); ?>" id="child_dob<?php echo $i; ?>">
																			</div>
																		</div>
																		<div class="col-md-2 col-sm-2 mnopad passport_num">
																			<div class="form-group inputtext">
																	...
																	<div class="col-md-2 col-sm-2 mnopad passport_exp">
																			<div class="form-group inputtext">
																				<input type="text" disabled  autocomplete="off" data-rule-required="true" data-msg-required="<?php echo $this->lang->line("required_star");
																					...
																					?>" class="inputs_group from_current_date"  id="child_passport_expire<?php echo $i; ?>">
																			</div>
																		</div>
																...
																<div class="traveller_div" id="infant_traveller<?php echo $i; ?>">
																	...
																	<i class="fa fa-list listpopbtn"></i> 
																		...
																		<div class="col-md-2 col-sm-2 mnopad d_o_b">
																			<div class="form-group inputtext">
																				<input type="text" autocomplete="off" data-rule-required="true" data-msg-required="<?php echo $this->lang->line("required_star");
																					?>" name="infant_dob[]" class="inputs_group till_current_date infant" readonly placeholder="<?php echo $this->lang->line('date_of_birth'); ?>" title="<?php echo $this->lang->line('date_of_birth'); ?>" id="infant_dob<?php echo $i; ?>">
																			</div>
																		</div>
														...
														<div class="clearfix"></div>
														   ...
														   <h3><?php echo $this->lang->line("contact_details"); ?></h3>
															...
															<div class="col-md-3 col-sm-3 bok_mrgtop">
																<div class="form-group inputtext">
																	<input type="text" autocomplete="off" data-rule-required="true" data-msg-required="<?php echo $this->lang->line("required_star");?>" data-rule-flexi_contact="true" name="contact" class="inputs_group mob_ltr" placeholder="<?php  echo ' +98-912-123-4455';//$this->lang->line('contact_number'); ?>" title="<?php echo $this->lang->line('contact_number'); ?>" value="<?php echo $user_exists ? $user_details->contact_no : ''; ?>">
																</div>
															</div>
															 <div class="col-md-6 col-sm-3 mob_overflo">
					...
					<ul class="timeline_1">
						<li>
							...
							<div class="col-md-12 cip-comm">
								...
								?>
									<label class="fulllab">
									    <div class="minwidh"><?php echo $airports[$cip_out_code]->city." (".$cip_out_code.")"; ?> - <span class="amount"><?php echo $flight_details->currency.' '.$cip_out_obj->cip_out; ?></span></div>
										<div class="radio_box">
							...
							<div class="col-md-12 cip-comm">
								...
								?>
									<label class="fulllab">
									<div class="minwidh"><?php echo $airports[$cip_in_code]->city." (".$cip_in_code.")"; ?> - <span class="amount"><?php echo $flight_details->currency.' '.$cip_in_obj->cip_in; ?></span></div>
										<div class="radio_box">
			...
			<div class="col-md-4 mn_nopadding_right mob_overflo">
						...
						<div class="cartitembuk prompform">
							<form class="discounts" action="javascript:void(0);" method="post">
								<div class="col-md-8 col-xs-8 mn_nopadding_right">
									<div class="cartprc">
										<div class="payblnhm singecartpricebuk ritaln">
											<input type="text" autocomplete="off" class="promocode" data-rule-required="false" name="code" placeholder="<?php echo $this->lang->line("enter_promocode"); ?>">
										</div>
									</div>
								</div>
								<div class="col-md-4 col-xs-4 mn_nopadding_left payblnhm">
