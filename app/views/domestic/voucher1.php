<?php
$booking_status = array("0" => "Pending", "1" => "Reserved", "2" => "Confirmed", "3" => "Cancelled");
...
<title><?php echo $this->lang->line("flight_voucher"); ?></title>
</head>
					...
					<tbody>
						<tr>
							<td><table width="100%" bgcolor="#ec4614" border="0" cellpadding="10" cellspacing="0">
								...
								<table width="100%" bgcolor="#fff" border="0" cellpadding="10" cellspacing="0">
									<tr>
										<td style="text-align:left;">
											...
											<?php echo $this->lang->line("xml_ref_no_colan"); ?> <span style="color:#ec4614"><?php echo $book_details->ticket_id; ?></span>
										</td>
										<td style="text-align:right"> 
											 <?php echo $this->lang->line("ticketed_date_colan"); ?> <span><?php echo empty($book_details->ticketed_date) ? $this->lang->line("na_caps") : $book_details->ticketed_date; ?></span><br/>
											<?php echo $this->lang->line("booked_date_colan"); ?> <span style="color:#ec4614"><?php echo $booking_status[$book_details->book_status]; ?></span>
										</td>
									</tr>
								</table>
								...
								?>
									<tr>
										...
										<td style="background:#fff;border:solid 1px #ccc;border-top:none;border-left:none; text-align:center"><?php echo isset($traveller_data->adult_passport[$i]) ? $traveller_data->adult_passport[$i] : "Not Required"; ?></td>
										<td style="background:#fff;border:solid 1px #ccc;border-top:none;border-left:none; text-align:center"><?php echo isset($traveller_data->adult_passport_expire[$i]) ? $traveller_data->adult_passport_expire[$i] : "Not Required"; ?></td>
								...
								<table width="100%" border="0" cellpadding="10" cellspacing="0">
									<tr>
										<td style="text-align:left; font-size:16px; color:#37c622;padding:10px 0"><img width="17" src="<?php echo asset_url('images/take1.png'); ?>" alt=""/> <?php echo $this->lang->line("departure"); ?></span></td>
									</tr>
								</table>
							<?php 
								...
								<table cellspacing="0" cellpadding="0" bgcolor="#fff" style="width:100%;border:solid 1px #ddd; text-align:center">
									<tr>
										...
										<td style="text-align:right; padding:5px 10px; font-size:13px;"><strong style="font-size:18px"><?php echo $departures[$i]->arrival_to; ?></strong><br>
											...
											<?php echo $departures[$i]->arrival_dttm === "0000-00-00 00:00:00" ? "Not Availble" : date("D, d M y, H:i", strtotime($departures[$i]->arrival_dttm))." hrs"; ?></span></td>
									</tr>
								</table>
							<?php
							}
							...
							?>
								<table width="100%" border="0" cellpadding="10" cellspacing="0">
									<tr>
										<td style="text-align:left; font-size:16px; color:#37c622;padding:10px 0"><img width="17" src="<?php echo asset_url('images/land1.png'); ?>" alt=""/> <?php echo $this->lang->line("arrival"); ?></span></td>
									</tr>
								</table>
							<?php 
