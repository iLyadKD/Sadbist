...
<div class="col-md-10 col-sm-10 col-xs-12 nopadding">
			  ...
			  <div class="hotelfilter_block">
					...
					<div class="col-md-11 col-sm-11 nopadding">
						<div class="sorting1">
						   <ul>
			               	   	<li><?php echo $this->lang->line("sort_by_colan"); ?></li>
			                    <li><a data-id="1" data-value="0"  class="segmented_btn" ng-click="predicate = 'star'; reverse=!reverse" href="#"><?php echo $this->lang->line("star_rating"); ?><span></span></a></li>
			                    <li><a data-id="2" data-value="0" class="segmented_btn" ng-click="predicate = 'hotel_price'; reverse=!reverse" href="#"><?php echo $this->lang->line("price"); ?><span></span></a></li>
			                    <li><a data-id="3" data-value="0" class="segmented_btn" ng-click="predicate = 'title'; reverse=!reverse" href="#"><?php echo $this->lang->line("hotel_name"); ?><span></span></a></li>
								<li>
				 ...
				 <div class="h-listing list-group listheight" id="products" ></div>
