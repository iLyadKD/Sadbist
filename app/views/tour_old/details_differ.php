        ...
        <div class="col-xs-12 nopadding">
          <div class="sortblock">
            <div class="col-md-3 col-sm-4 col-xs-12 border-rt">
              <div class="checkin2"><span class="loc1">
                <?php
				...
				if($gen_info->no_of_day > 1)
				  ...
				  $d_str ='';
			  ?>
                <?php echo $gen_info->tour_name;?>, <?php echo $gen_info->no_of_night.'&nbsp;Night'.$n_str;?> <?php echo $gen_info->no_of_day.'&nbsp;Day'.$d_str;?> :</span> </div>
            </div>
      ...
      <div class="row">
        ...
        height: 460px; overflow: hidden;">
                        ...
                        <div class="col-md-12 col-sm-6 pull-right mn_top_packge">
                          <form name="book_now" id="book_now" method="post" action="<?php echo base_url('tour/prebooking')?>">
                            <div class="col-md-12"> 
                              ...
                              <!--<input type="hidden"   name="final_infants" id="final_infants">
						  <input type="hidden"   name="final_twotosix" id="final_twotosix">
						  <input type="hidden"   name="final_sixtotwelve" id="final_sixtotwelve">
						  <input type="hidden"   name="final_twelvetosixteenth" id="final_twelvetosixteenth">-->
            ...
            <div class="fix"> 
              <!--<div class="col-md-12 nopadding">
                <div class="package_widget">
                  <h2><?php echo $gen_info->tour_name;?></h2>
                 <p class="more"><?php echo strip_tags($gen_info->overview);?></p>
            ...
            <div class="fix">
              <div class="col-md-12 nopadding">
                <div class="col-md-3">
                  <h4><i class="fa fa-hotel" style="display: inline;"></i> Hotels </h4>
                </div>
                <div class="col-xs-12 col-md-9 pull-right nopadding flight_check">
                  <div class="col-xs-12 nopadding flight_check small_fnt">
                    <?php 
					  ...
					  $t_price = '';
					  $b_price = '';
					  if(!empty($flights)){ $f=0; foreach($flights as $flight) {
                    ...
                    <?php $f++; } } ?>
                    <?php if(!empty($cruises)){ $c = 0; foreach($cruises as $cruise) {
                    ...
                    <?php $c++; } } ?>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php if(!empty($trains)){ $t=0; foreach($trains as $train) {
						if($trans_flag == "train"){
						  if($t == 0){
							$checked = 'checked';
						  }
                    ...
                    <div class="mn_ta">
                      <table class="table table-bordered">
                        <tr style=" background: #f5f5f5; ">
                          <th style="width: 120px;"> <span>Hotel Name</span> </th>
                        ...
                        <?php if(!empty($hotels)) { foreach($hotels as $hotel) { 
							...
							if($hotel['hotel_id'] == $selected_hotel && $hotel['room_type'] == 'Standard'){
							  ...
							  $hotel_chk = '';
							  $spcl = "spcl";
							  $tr_style = 'style="background-color:#e6e6e6"';
							  $data_target = "";
							  $input_scope = 'disabled';
							  $people_count = '';
							  $name = $hotel['room_type'];
							  $td_style="margin-left:25px;";
							  $mn_class="mn_night_spcl";
							  $rm_txt = '';
							}
						  ?>
                        <tr class="table_tr main_tr" <?php echo $tr_style?> data-id="tr<?php echo $hotel['id'];?>">
                          <input type="hidden"  id="master_id" value="<?php echo $hotel['id'];?>">
                          <input type="hidden" id="hotel_id" value='<?php echo $s_id;?>'>
                          <td style="width: 600px;"><div class="check_box" style="<?php echo $td_style?>"  >
                              <input value="<?php echo $s_id;?>" class="hotel_variables" type="checkbox" data-id="<?php echo $hotel['id'];?>" data-value="<?php echo trim($hotel['latitude']).'-'.trim($hotel['longitude']).'-'.$hotel['name'].'-'.$hotel['handle_charge']*$currency;?>" name="hotels" id="<?php echo 'hotel_'.$hotel['id'];?>" <?php echo $hotel_chk;?>/>
                              <label for="<?php echo 'hotel_'.$hotel['id'];?>"> <span><?php echo $name.$rm_txt;?></span> </label>
                              <div class="clearfix"></div>
                            </div>
                            <br/>
                            <?php
								$star_img = base_url('assets/images/star_rating_'.$hotel['rating'].'.png');
							?>
                            <input type="hidden" id="extra_total<?php echo $hotel['id'];?>">
                            <?php if($spcl == '') { ?>
                            <img src="<?php echo $star_img;?>" alt=""/>&nbsp;
                            <?php
							  $check_extra = $this->Tour_model->check_extra($hotel['tour_id'],$hotel['hotel_id'],$hotel['tour_date'],$hotel['room_type']);
							  if(!empty($check_extra)){
							?>
                            <span class="<?php echo $mn_class;?> ex-night" style=""  data-id="<?php echo $hotel['id'];?>" data-value="single/<?php echo $tour_date;?>" id="single<?php echo $hotel['id'];?>" data-target="<?php echo $data_target;?>" data-toggle="modal">Extra Night</span>
                            <?php } else {  ?>
							
							<span class="<?php echo $mn_class;?> ex-night" style="">&nbsp;</span>
							<?php } ?>
							<?php
							  if($hotel['food_type'] == 1){
								$food_type = "Breakfast only";
							  }elseif($hotel['food_type'] == 2){
								$food_type = "ALL";
							  }elseif($hotel['food_type'] == 3){
								$food_type = "UALL";
							  }elseif($hotel['food_type'] == 4){
								$food_type = "Breakfast and Lunch";
							  }elseif($hotel['food_type'] == 5){
								$food_type = "Breakfast and Dinner";
							  }else{
								$food_type = "";
							  }
							?>
                            <span class="text-center tabletool tools"> <a href="#"  class="tooltips" > <img width="25" src="<?php echo base_url('assets/images/dinner.png');?>"> <span><?php echo $food_type;?></span> </a> </span>
                            <?php } ?></td>
                          ...
                          <td style="width: 139px;font-size: 9px;text-align: center;"><div style="width:100%;"> <span id="display_single<?php echo $hotel['id'];?>"  style="height:19px; padding:0px;"> <?php echo $hotel['single']*$currency;?></span>
                            ...
                            <div class="tools"> <a class="tooltips" >
                              <input <?php echo $input_scope;?> data-toggle="tooltip"  class="txt_count" data-id="<?php echo 'hotel_'.$hotel['id'];?>" data-master="<?php echo $hotel['id'];?>" data-value="single" id="count_single<?php echo $hotel['id'];?>" onkeypress="return isNumberKey(event);" type="number" min="0" max="10"  style="text-align:center;width: 50px;" value="" >
                          ...
                          <td style=" width:139px; font-size: 9px;text-align: center;" class="hotel_list"><div style="width:100%;"> <span id="display_double<?php echo $hotel['id'];?>"  style="height:19px; padding:0px;"> <?php echo $hotel['doubles']*$currency;?></span>
                            ...
                            <div class="tools"> <a class="tooltips">
                              <input <?php echo $input_scope;?>   class="txt_count <?php echo $spcl;?>" data-id="<?php echo 'hotel_'.$hotel['id'];?>" data-master="<?php echo $hotel['id'];?>" data-value="double" id="count_double<?php echo $hotel['id'];?>"   onkeypress="return isNumberKey(event,this.value);"   type="number" min="0" max="10" step="2" style="text-align:center;width: 50px;" value="<?php echo $people_count;?>" >
                              <span>No of persons</span> </a> </div></td>
                          <td style="width: 139px;font-size: 9px;text-align: center;"><div style="width:100%;"> <span id="display_triple<?php echo $hotel['id'];?>" style="height:19px; padding:0px;"> <?php echo $hotel['triple']*$currency;?></span>
                            ...
                            <div class="tools"> <a class="tooltips">
                              <input <?php echo $input_scope;?> data-toggle="tooltip"  class="txt_count" data-id="<?php echo 'hotel_'.$hotel['id'];?>" data-master="<?php echo $hotel['id'];?>" data-value="triple" id="count_triple<?php echo $hotel['id'];?>" onkeypress="return isNumberKey(event);"   type="number" min="0" max="12" step="3" style="text-align:center;width: 50px;" value="" >
                              <span>No of persons</span> </a> </div></td>
                          <td style="width: 139px;font-size: 9px;text-align: center;" class="hotel_list"><div style="width:100%;"> <span id="display_infants<?php echo $hotel['id'];?>" style="height:19px; padding:0px;"><?php echo $hotel['infants']*$currency;?>
                            ...
                            <div class="tools"> <a class="tooltips">
                              <input <?php echo $input_scope;?> data-toggle="tooltip"  class="txt_count <?php echo $spcl;?>" data-id="<?php echo 'hotel_'.$hotel['id'];?>" data-master="<?php echo $hotel['id'];?>" data-value="infants" id="count_infants<?php echo $hotel['id'];?>"  onkeypress="return isNumberKey(event);"  type="number" min="0" max="10" style="text-align:center;width: 50px;" value="" >
                          ...
                          <td style="font-size: 9px;text-align: center;" class="hotel_list"><div class="pull-left" style="width:90px;"> <span id="display_twotosix<?php echo $hotel['id'];?>"  style="height:19px; padding:0px;"> <?php echo $hotel['twotosix']*$currency;?>
                            ...
                            <div class="tools"> <a class="tooltips">
                              <input <?php echo $input_scope;?> data-toggle="tooltip"  class="txt_count <?php echo $spcl;?>" data-id="<?php echo 'hotel_'.$hotel['id'];?>" data-master="<?php echo $hotel['id'];?>" data-value="twotosix" id="count_twotosix<?php echo $hotel['id'];?>"  onkeypress="return isNumberKey(event);"  type="number" min="0" max="10" style="text-align:center;width: 50px;" value="" >
                          ...
                          <td style="font-size: 9px;text-align: center;" class="hotel_list"><div class="pull-left" style="width:90px;"> <span id="display_sixtotwelve<?php echo $hotel['id'];?>"  style="height:19px; padding:0px;"><?php echo $hotel['sixtotwelve']*$currency;?>
                            ...
                            <div class="tools"> <a class="tooltips">
                              <input <?php echo $input_scope;?> data-toggle="tooltip"  class="txt_count <?php echo $spcl;?>" data-id="<?php echo 'hotel_'.$hotel['id'];?>" data-master="<?php echo $hotel['id'];?>" data-value="sixtotwelve" id="count_sixtotwelve<?php echo $hotel['id'];?>"  onkeypress="return isNumberKey(event);"  type="number" min="0" max="10" style="text-align:center;width: 50px;" value="" >
                          ...
                          <td style="font-size: 9px;text-align: center;" class="hotel_list"><div class="pull-left" style="width:90px;"> <span id="display_twelvetosixteenth<?php echo $hotel['id'];?>"  style="height:19px; padding:0px;"><?php echo $hotel['twelvetosixteenth']*$currency;?>
                            ...
                            <div class="tools"> <a class="tooltips">
                              <input <?php echo $input_scope;?> data-toggle="tooltip"  class="txt_count <?php echo $spcl;?>" data-id="<?php echo 'hotel_'.$hotel['id'];?>" data-master="<?php echo $hotel['id'];?>" data-value="twelvetosixteenth" id="count_twelvetosixteenth<?php echo $hotel['id'];?>"   onkeypress="return isNumberKey(event);" type="number" min="0" max="10" style="text-align:center;width: 50px;" value="" >
