                                    ...
                                    <div class="scrollable-area">
                                       ...
                                       <table class="table table-bordered manage_cc_items" style="margin-bottom:0;">
                                          ...
                                          <tbody>
                                               ...
                                               <td><?php echo isset($flightData->flight_origin) ? $CI->get_actual_english_text($flightData->flight_origin) : '-';?></td>
                                               <td><?php echo isset($flightData->flight_destination) ? $CI->get_actual_english_text($flightData->flight_destination) : '-';?></td>
                                               <td><?php 
