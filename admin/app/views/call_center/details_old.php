											...
											<form class="form form-horizontal update-item-details-form" action="javascript:void(0);" method="post" enctype="multipart/form-data"> 
												...
												<div class="form-group">
													...
													<div class="col-sm-2 controls">
														...
														<input <?php echo !$has_permission ? '' : 'name="flight_date"'?> autofocus="true" class="form-control" type="text" disabled value="<?php echo date('y/m/d h:i', strtotime($departures->departure_dttm)); ?>">
													</div>

													<div class="col-sm-2 controls">
														<label>From</label>
														<input <?php echo !$has_permission ? '' : 'name="from"'?> autofocus="true" class="form-control" type="text" disabled value="<?php echo $CI->get_actual_text($departures->departure_from); ?>">
													</div>

													<div class="col-sm-2 controls">
														<label>To</label>
														<input <?php echo !$has_permission ? '' : 'name="to"'?> autofocus="true" class="form-control" type="text" disabled value="<?php echo $CI->get_actual_text($departures->arrival_to); ?>">
													</div>

													<div class="col-sm-2 controls">
														<label>Airline Name</label>
														<input <?php echo !$has_permission ? '' : 'name="airline_name"'?> autofocus="true" class="form-control" type="text" disabled value="<?php echo $departures->airline_name; ?>">
													</div>

													<div class="col-sm-2 controls">
														<label>Flight No.</label>
														<input <?php echo !$has_permission ? '' : 'name="flight_no"'?> autofocus="true" class="form-control" type="text" disabled value="<?php echo 1000 + $item_det->item_id; ?>">
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-1 controls">
														<label>DOB</label>
														<input autocomplete="off" tabindex="1" autofocus="true" class="form-control dt_dob <?php echo $pvalue;?>" type="text" <?php echo $enabled ?> value="<?php echo $dob[$i]; ?>" <?php echo !$has_permission ? '' : 'name="traveller_det[' . $pvalue . '_dob][]"' ?> >
													</div>
													<div class="col-sm-2 controls">
													...
													<div class="col-sm-2 controls <?php echo $pvalue.$i;?> non_iran_class" style="display:<?php echo $pass_display; ?>">
														...
														<input autocomplete="off" tabindex="1" autofocus="true" class="form-control from_current_date" type="text" <?php echo $enabled ?> value="<?php echo date('d/m/Y',strtotime(@$passport_expire[$i])); ?>" <?php echo !$has_permission ? '' : 'name="traveller_det[' . $pvalue . '_passport_expire][]"'?> >
													</div>
												</div>
												<?php 
													}
												...
												<div class="form-group">
													...
													<div class="col-sm-2 controls">
														<label>URL</label>
														<div>
															<button onclick="window.open('<?php echo @$dataCharter->url ?>', ''); return false;" class="btn btn-primary" <?php echo !$has_permission && $dataCharter == '' ? 'disabled' : '' ?>  type="button">
													...
													<?php if ($first_url != '') { ?>
														<div class="col-sm-<?php echo $first_url != '' ? '2' : '4' ?> controls">
															<label>One Way URL</label>
															<div>
																<button <?php echo $enabled ?> 
																<?php echo !$has_permission ? '' : 'onclick="window.open(\'' . $first_url . '\', \'\'); return false;"'?>
													...
													<?php if ($second_url != '') { ?>
														<div class="col-sm-2 controls">
															...
															<div>
																<button <?php echo $enabled ?> <?php echo !$has_permission ? '' : 'onclick="window.open(\'' . $second_url . '\', \'\'); return false;"'?> class="btn btn-primary" type="button">
																	<i class="icon-globe"></i>
																	Visit
																</button>
															</div>
													...
													<div class="col-sm-4 controls">
														...
														<input autocomplete="off" tabindex="1" autofocus="true" class="form-control" type="text" <?php echo $enabled ?> value="<?php echo ($item_det->actual_purchase_price != "") ? $item_det->actual_purchase_price : ''; ?>" <?php echo !$has_permission ? '' : 'name="actual_price"'?>>
													</div>
													<div class="col-sm-2 controls">
														<label>PNR Number</label>
														<input <?php echo !$has_permission ? '' : 'name="cc_pnr_number"'?> autofocus="true" class="form-control" type="text" <?php echo $enabled ?> value="<?php echo $item_det->pnr_number; ?>">
													</div>
													<div class="col-sm-2 controls">
