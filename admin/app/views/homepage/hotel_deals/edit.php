								...
								<div class="col-sm-12">
									...
									<div class="box">
										...
										<div class="box-content">
											<form class="form form-horizontal update_hotel_deals" action="javascript:void(0);" method="post" hyperlink="<?php echo $hotel_deals_id;?>">
											<div class="form-group">
											<img class="form-group col-sm-3 pull-left preview_img" src="<?php echo $hotel_deals->image === '' ? asset_url(IMAGE_PATH.'default.png') : upload_url($hotel_deals->image);?>" alt='No Image.' width="80" height="80">
												</div>

												<div class="form-group">
													<label class="control-label col-sm-3 required">Select Image</label>
													<div class="col-sm-5 controls">
														<input hyperlink = "<?php echo $hotel_deals->image;?>" autocomplete="off" tabindex="3" class="form-control filestyle" data-classButton="btn btn-primary" data-input="true"  data-buttonText="Select" data-rule-required="false" name="slider_image" type="file" data-msg-required="Please select image" accept="image/*" data-rule-accept="image/*" data-msg-accept="Please select image only.">
													</div>
												</div>
												...
												<div class="sector_tour" >
													<div class="form-group">
														...
														<div class="col-sm-5 controls">
															<select hyperlink = "<?php echo $master_id;?>" data-rule-required="true" data-msg-required="Please select any hotel"    autofocus="true" class="select2 form-control hotel_list valid" id="hotel_list" data-rule-required="true"  data-msg-required="Please select any tour">
																<input  type="hidden" value="<?php echo $hotel_deals->tour_link;?>" class="valid" name='tour_link' >
																<input  type="hidden" value="<?php echo $hotel_deals->master_id;?>" class="valid" name='master_id' >
