								...
								<div class="col-sm-12">
									...
									<div class="box">
										...
										<div class="box-content">
											<form class="form form-horizontal add_tour_deals" action="javascript:void(0);" method="post">
												
												<div class="form-group">
													<label class="control-label col-sm-3 required">Deals text(En)</label>
													<div class="col-sm-8 controls">
														<input  autocomplete="off" tabindex="1" autofocus="true" class="form-control" data-rule-required="true" name="content_en" placeholder="ex:-Last minute deals" type="text" data-msg-required="Please enter deals content" >
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8 controls">
														<input autocomplete="off" tabindex="2" autofocus="true" class="form-control" data-rule-required="true" name="content_fa" placeholder="ex:-Last minute deals" type="text" data-msg-required="Please enter deals content" >
													</div>
											<img class="form-group col-sm-3 pull-left preview_img" src="<?php echo asset_url(IMAGE_PATH.'default.png');?>" alt='No Image.' width="80" height="80">
												...
												<div class="sector_tour" >
													<div class="form-group">
														...
														<div class="col-sm-5 controls">
															<select data-rule-required="true" data-msg-required="Please select any hotel"    autofocus="true" class="select2 form-control tour_list" id="tour_list" data-rule-required="true"  data-msg-required="Please select any tour">
