										...
										<div class="box-content">
											<form class="form form-horizontal add_airport_form"  action="javascript:void(0);" method="post">
												...
												<div class="form-group">
													...
													<div class="col-sm-4 controls">
														<input class="form-control" autocomplete="off" data-rule-required="true" name="airport_en" placeholder="Airport Name (English)" type="text">
													</div>
													<div class="col-sm-4 controls">
														<input class="form-control" autocomplete="off" data-rule-required="true" name="airport_fa" placeholder="Airport Name (Farsi)" type="text">
													</div>
												</div>
