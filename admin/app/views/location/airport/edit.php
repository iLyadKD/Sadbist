									...
									<div class="box">
										...
										<div class="box-content">
											<form class="form form-horizontal update_airport_form" hyperlink="<?php echo $airport_id; ?>" action="javascript:void(0);" method="post">
												...
												<div class="form-group">
													<label class="control-label col-sm-3">Airport Name</label>
													<div class="col-sm-4 controls">
														<input class="form-control" autocomplete="off" data-rule-required="false" name="airport_en" placeholder="Airport Name (English)" value="<?php echo $airport->airport_en; ?>" type="text">
													</div>
													<div class="col-sm-4 controls">
														<input class="form-control" autocomplete="off" data-rule-required="false" name="airport_fa" placeholder="Airport Name (Farsi)" value="<?php echo $airport->airport_fa; ?>" type="text">
													</div>
												</div>
