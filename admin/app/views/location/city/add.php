										...
										<div class="box-content">
											<form class="form form-horizontal add_city_form" action="javascript:void(0);" method="post">
												...
												<div class="form-group">
													...
													<div class="col-sm-4 controls">
														<input class="form-control" autocomplete="off" data-rule-number="true" data-rule-required="false" name="latitude" placeholder="Latitude" type="text">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-4 controls">
														<input class="form-control" autocomplete="off" data-rule-number="true" data-rule-required="false" name="longitude" placeholder="Longitude" type="text">
													</div>
												</div>
