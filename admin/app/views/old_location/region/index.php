								...
								<div class="col-sm-12">
									...
									<div class="box bordered-box orange-border">
										<div class="box-header blue-background">
											...
											<div class="actions">
												<a class="btn" href="<?php echo base_url($this->data['controller'].DIRECTORY_SEPARATOR.$this->data['method'].'_add'.DEFAULT_EXT); ?>"><i class="icon-plus-sign"></i> Add State/Region</a>
											</div>
										</div>
										<div class="box-content box-no-padding">
											<div class="responsive-table">
												<div class="scrollable-area">
													<table class="data-table-column-filter table table-bordered table-striped manage_states">
														<thead>
															<tr role="row" class="heading">
																<th>Sl No.</th>
																<th>Country Name</th>
																<th>State Name (English)</th>
																<th>State Name (Farsi)</th>
																<th>Status</th>
																<th>Actions</th>
															</tr>
														</thead>
