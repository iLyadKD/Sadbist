								...
								<div class="col-sm-12">
									...
									<div class="box bordered-box orange-border">
										<div class="box-header blue-background">
											...
											<div class="actions">
												<a tabindex="1" class="btn" href="<?php echo base_url($this->data['controller'].'/add'.DEFAULT_EXT); ?>"><i class="icon-plus-sign"></i> Add New Privilege</a>
											</div>
										</div>
										<div class="box-content box-no-padding">
											<div class="responsive-table">
												<div class="scrollable-area">
													<table class="data-table-column-filter table table-bordered table-striped manage_privileges">
														<thead>
															<tr>
																<th>Sl No.</th>
																<th>Controller</th>
																<th>Icon</th>
																<th>Display Privilege</th>
																<th>URL</th>
																<th>Menu Type</th>
																<th>Order By</th>
																<th>Submenu Order</th>
