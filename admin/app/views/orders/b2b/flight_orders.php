...
<html>
<head>
    <title>B2B Flight Booking Reports | <?php echo PROJECT_NAME; ?></title>
                            ...
                            <div class='col-sm-12'>
                                <div class='page-header'>
                                    <h1 class='pull-left'>
                                        ...
                                        <span>B2B Flight Booking Reports</span>
                                    </h1>
                                    <div class='pull-right'>
                                        <ul class='breadcrumb'>
                                            ...
                                            <li class='active'>B2B Flight Booking Reports</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='col-sm-12'>
                                <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                                    <div class='box-header blue-background'>
                                        <div class='title'>B2B Flight Booking Reports</div>
                                        <div class="actions">
                                            <a class='btn' href="<?php echo WEB_URL; ?>b2b_orders/flight_bookings_export"><i class='icon-download'></i> PDF</a>
                                            <a class='btn' href="<?php echo WEB_URL; ?>b2b_orders/export_flight_bookings"><i class='icon-download'></i> Excel</a> 
                                        </div>
                                    </div>
                                <div> 
                            </div>
