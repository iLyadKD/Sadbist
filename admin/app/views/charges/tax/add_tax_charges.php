										...
										<div class="box-content">
											<form class="form form-horizontal add_pg_charges_form" action="javascript:void(0);" method="post">
												...
												<div class="form-group">
													<label class="control-label col-sm-3 required">Select Tax</label>
													<div class="col-sm-5 controls">
														<select tabindex="1" autofocus="true" class="select2 form-control set_taxes" data-rule-required="true" name="tax_name" id="tax_name" data-msg-required="Please select Tax Name">
														</select>
													</div>
												</div>
												...
												<div class="form-group payable_amount_div">
													...
													<div class="col-sm-5 controls">
														<input autocomplete="off" tabindex="4" class="form-control" data-rule-required="true" name="tax_amount" placeholder="Amount" type="text" data-msg-required="Please enter valid value" data-rule-min= "0">
													</div>
												</div>
