                      ...
                      <form class="form form-horizontal package_type" style="margin-bottom: 0;" action="" method="post">
                           <div class="form-group">
                            ...
                            <div class="col-sm-4 controls">
                               <input  autocomplete="off" class="form-control" autocomplete="off" data-rule-required="true" data-msg-required="Please enter tour type"   type="text" placeholder="Tour Type" name="tour_type" value="<?php echo $row->package_type;?>"  >
                            </div>                     
