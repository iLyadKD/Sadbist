				...
				<div class="container">
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-sm-5 controls">
                              <select class='form-control' data-rule-required='true' name='package[type]' id="type" >
                                ...
                                <?php foreach ($package_type as $type_row) { $type = json_decode($type_row->package_type) ?>
                    ...
                    <fieldset>
                      ...
                      <div class="form-vertical">
                        <div class="row-fluid">
                          <div class="col-md-3">
                            <label class="controls">From Date</label>    
                            <input type="text" class="form-control" placeholder="MM/DD/YYYY" id="fromdate" name="duration[from_date][]"   type="text"  data-rule-required='true'>      
                          </div>
                          <div class="col-md-3 ">
                            <label class="controls">To Date</label>
                            <input type="text" class="form-control" placeholder="MM/DD/YYYY" id="todate" name="duration[to_date][]"   type="text"  data-rule-required='true'>      
                          </div>
                          <div class="col-md-3">
                            <label class="controls">Adult Price($)</label>
                            <input type="text" class="form-control" placeholder="Adult Price" id="adult_price" name="duration[adult_price][]"  type="text" min="1" data-rule-number='true' data-rule-required='true' >
                          </div>
                          <div class="col-md-3">
                            <label class="control-label">Child  Price($)</label>
                            <input type="text" class="form-control" placeholder="Child Price" id="child_price" name="duration[child_price][]"  type="text" min="1" data-rule-number='true' data-rule-required='true'>   
                          </div>
                          </div>
                      </div>
                        ...
                        <div class="extra_price"></div>
                         ...
                         <!--<input type="button" name="add_price" class="add_price" value="add">-->
                          ...
                          <div class='col-sm-4 controls'>
                            <select name="cancel_type" id="cancel" class="form-control">
                              ...
                              <div class="cancel_policy_type" style="display:none">
                                <div class="row-fluid " id="cancel_policy" >
                                  <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control"  placeholder="" id="cancel_days" name="cancel[cancel_days][]"   type="text"  data-rule-required='true'  min="1" max="30">      
                                  </div>
                                  <div class="col-md-3 ">
