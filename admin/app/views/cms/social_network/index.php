								...
								<div class="col-sm-12">
									...
									<div class="box bordered-box orange-border">
										<div class="box-header blue-background">
											...
											<div class="actions">
												<a tabindex="1" href="javascript:void(0);" class="add_social_network"> <button class="btn"><i class="icon-plus-sign"></i> Add Social-Network</button></a>
											</div>                     
										</div>
										<div class="box-content box-no-padding">
											<div class="responsive-table">
												<div class="scrollable-area">
													...
													<table class="data-table-column-filter table table-bordered table-striped manage_social_network">
														<thead>
															<tr>
																<th>Sl No.</th>
																<th>Title</th>
