												...
												<div class="box-content box-no-padding">
													<div class="responsive-table">
														<div class="scrollable-area">
															<table class="data-table-column-filter table table-bordered table-striped manage_b2b_markups">
																<thead>
																	<tr>
																		<th>Sl No.</th>
																		<th>Markup Type</th>
																...
																<tbody><tr class="odd text-center"><td valign="top" colspan="12" class="dataTables_empty"><i class="bar_loading"></i></td></tr></tbody>
																<tfoot>
																	<tr>
																		<th>Sl No.</th>
																		<th>Markup Type</th>
