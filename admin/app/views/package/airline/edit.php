              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <div class="box">
                    ...
                    <!-- Form-->
                     <?php echo form_open_multipart(base_url("package/edit_airlines/".$id),array('class' => 'form form-horizontal','id'=>'add_tour_airline','method'=>'post'));?>
                     
                          <div class="form-group"> 
                            <label class="col-md-2 control-label required" >Airline Name (English)</label>
                            <div class="col-sm-4 controls">
                              <input type="text" value="<?php echo $airlines->airline_en;?>" class='form-control' type="text" name="airline_en"  placeholder="Airline Name" data-rule-required='true'  >
							</div>
                          </div>
						   <div class="form-group"> 
                            <label class="col-md-2 control-label required" >Airline Name (Farsi)</label>
                            <div class="col-sm-4 controls">
                              <input type="text" value="<?php echo $airlines->airline_fa;?>" class='form-control' type="text" name="airline_fa"  placeholder="Airline Name" data-rule-required='true'  >
							</div>
                          </div>
                          ...
                          <div class="form-group">               
                           <label class="col-md-2 control-label required"  >Country</label>
                             <div class="col-sm-4 controls">
                                <select name="airline_country" class="form-control select2 hotel_country" data-rule-required='true'>
                                  <option value="">Select Country</option>
                                  <?php if($country) {foreach ($country as $rows) { ?>
                                  <option value="<?php echo $rows->name?>"  <?php if($rows->name== $airlines->airline_country){ echo "selected";}?>><?php echo $rows->name?></option>
                                  <?php } }?>
                              </select>
                              </div>                          
                          </div>
                          ...
                          <div class="form-group">
							...
							<div class='col-sm-4 controls'>
                              <div class="gallery" id="validation_logo">
                                <input type="file"  class="form-control" name="airline_logo"  data-rule-accept="image/*"  accept=".someext,image/*" /><br>
                              </div>
							...
							<?php  if($airlines->airline_logo != '') { ?>
								<div class='col-sm-6 '>
									<div class='row'>
										<div class='col-sm-2'  id="validation_logo">
											<img width="50px;" height="35px;" src="<?php echo upload_url('tour/airline_logo/'.$airlines->airline_logo); ?>"    style="border:1px solid #CCC;">
										</div>
									</div>
								</div>
							<?php }  ?>
