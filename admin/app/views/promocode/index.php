								...
								<div class="col-sm-12">
									...
									<div class="box bordered-box orange-border">
										<div class="box-header blue-background">
											...
											<div class="actions">
											 <a tabindex="1" href="<?php echo base_url($this->data['controller'].'/add_promo'.DEFAULT_EXT); ?>"> <button class="btn"><i class="icon-plus-sign"></i> Add Promo Code</button></a>
											</div>
										</div>
										<div class="box-content box-no-padding">
											<div class="responsive-table">
												<div class="scrollable-area">
													<table class="data-table-column-filter table table-bordered table-striped manage_promocodes">
														<thead>
															<tr>
																<th>Sl No.</th>
																<th>Promo Code</th>
