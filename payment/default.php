                        ...
                        <td>
                            ...
                            <table class="MainTable" cellspacing="5" cellpadding="1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="PayCallBackUrl" id="PayCallBackUrl" value="http://10020.ir/payment_beta/response.php">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="LabelTd">
...
<?php
	...
	{ 
		$terminalId = $_POST['TerminalId'] = '2108481';
		$userName = $_POST['UserName'] = 'ir100';
		$userPassword = $_POST['UserPassword'] = '29961660';
		...
		$callBackUrl = $_POST['PayCallBackUrl'] = 'http://10020.ir/payment_beta/response.php';
